...
export default function TermsLegalContent() {
  return (
    <>
      <section className="terms-modal-section" aria-labelledby="terms-m-s1">
        <h3 id="terms-m-s1" className="terms-modal-section-title">
          1. Who we are
        </h3>
        <p>
      ...
      <section className="terms-modal-section" aria-labelledby="terms-m-s2">
        <h3 id="terms-m-s2" className="terms-modal-section-title">
          2. The service
        </h3>
        <p>
      ...
      <section className="terms-modal-section" aria-labelledby="terms-m-s3">
        <h3 id="terms-m-s3" className="terms-modal-section-title">
          3. Account &amp; eligibility
        </h3>
        <p>
          You must provide accurate registration information and keep login credentials confidential. You are responsible
          for activity under your account. You must not misuse the service, attempt unauthorised access, or use it in a
          way that infringes others’ rights or applicable law.
        </p>
      </section>
      ...
      <section className="terms-modal-section" aria-labelledby="terms-m-s5">
        <h3 id="terms-m-s5" className="terms-modal-section-title">
          5. Right of withdrawal (EU / UK consumers)
        </h3>
        <p>
          If you are a <strong>consumer</strong> in the European Economic Area or the United Kingdom, you generally have
          a <strong>14-day right to cancel</strong> distance contracts under Directive 2011/83/EU (as implemented
          nationally) and the UK Consumer Contracts Regulations 2013.
        </p>
        <p>
      ...
      <section className="terms-modal-section" aria-labelledby="terms-m-s7">
        <h3 id="terms-m-s7" className="terms-modal-section-title">
      ...
      <section className="terms-modal-section" aria-labelledby="terms-m-s8">
        <h3 id="terms-m-s8" className="terms-modal-section-title">
          8. Intellectual property
        </h3>
        <p>
          The service, branding, and underlying materials are protected by intellectual property laws. We grant you a
          limited, non-exclusive, non-transferable right to use Plannix for your own planning purposes in line with these
          terms. You retain rights to content you upload; you give us only the licence needed to host and display it for
          you within the service.
        </p>
      </section>

      <section className="terms-modal-section" aria-labelledby="terms-m-s9">
        <h3 id="terms-m-s9" className="terms-modal-section-title">
          9. Liability
        </h3>
        <p>
      ...
      <section className="terms-modal-section" aria-labelledby="terms-m-s10">
        <h3 id="terms-m-s10" className="terms-modal-section-title">
          10. Changes &amp; contact
        </h3>
        <p>
        ...
        <p>
          ...
          for information purposes; we are not obliged to participate in every alternative dispute resolution procedure
